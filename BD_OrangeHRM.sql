...
/*se afiseaza toti angajatii care nu au dependent*/
select * from Employee left join Dependent on Employee.EmployeeId = Dependent.EmployeeId
where Dependent.EmployeeId is null;

/*se afiseaza toti angajatii care au dependent*/
select * from Employee left join Dependent on Employee.EmployeeId = Dependent.EmployeeId
where Dependent.EmployeeId is not null;
